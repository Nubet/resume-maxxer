...
export const metadata: Metadata = {
  ...
  description: "Zbuduj nowoczesne, minimalistyczne CV w architekturze po stronie klienta (Client-Side). Kompilacja Typst dla 100% czytelności w systemach ATS, bez baz danych i śledzenia.",
};
